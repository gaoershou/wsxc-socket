...
var RDS_OPTS = {auth_pass:'gaoershou'};
...
var primaryKeys = [
    ...
    'edwinbj_user_key',
    'edwinbj_push_job_key',
    'edwinbj_myself_job_key',
];
...
// register for promise
redisDb.hsetPromise = function(key, id, value, expire){
...
redisDb.hgetPromise = function(table, key){
    return new Promise(function(reslove, reject){
        client.hget(table, key, function(err, result){
            if (err) {
...
redisDb.hexistsPromise = function(table, key){
    return new Promise(function(reslove, reject){
        client.hexists(table, key, function(err, result){
            if (err) {
                reject(err);
...
redisDb.hmgetPromise = function(table,values){
    return new Promise(function(reslove, reject){
        client.hmget(table, values, function (err, result){
            if (err) {
                reject(err);
...
redisDb.zaddPromise = function(table, score, value){
    return new Promise(function(reslove, reject){
        client.zadd(table, score, value, function(err, result){
            if (err) {
                reject(err);
...
redisDb.zrangePromise = function(table,begianNum, endNum){
    return new Promise(function(reslove, reject){
        client.zrange (table, begianNum, endNum, function(err, result){
            if (err) {
                reject(err);
...
redisDb.zrevrangePromise = function(table,begianNum, endNum){
    return new Promise(function(reslove, reject){
        client.zrevrange (table, begianNum, endNum, function(err, result){
            if (err) {
                reject(err);
...
redisDb.hincrbyPromise = function(table,key,num){
    return new Promise((reslove,reject) => {
        client.hincrby(table,key,num,(err,result)=>{
            if(err){
                console.log(err);
                reject(err);
            }else{
...
redisDb.zinterstorePromise = function(newTable, num, table1,table2){
    return new Promise((reslove,reject) => {
        client.zinterstore (newTable, num, table1, table2, function(err, result){
            if (err) {
                reject(err);
...
redisDb.zunionstorePromise = function(newTable, num, values){
    return new Promise(function(reslove, reject){
        if (num ==5) {
            client.zunionstore (newTable, num, values[4],values[3],values[2],values[1],values[0], function(err, result){
                if (err) {
...
redisDb.zcardPromise = function(table){
    return new Promise(function(reslove, reject){
        client.zcard(table, function(err, result){
            if (err) {
                reject(err);
